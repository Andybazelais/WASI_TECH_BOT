...
global.devs = '50931312968';
global.website = 'https://github.com/Itxxwasi/WASI_TECH_BOT' //wa.me/+923192173398
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://raw.githubusercontent.com/SecktorBot/Brandimages/main/logos/SocialLogo%201.png'
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'Andy 𝐁𝐨𝐭' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Andy' : process.env.OWNER_NAME,
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? 'ANDY-MD' : process.env.PACK_INFO.split(";")[1],
